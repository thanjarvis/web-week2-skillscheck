...
const faveColors = ['green', 'yellow', 'blue']
...
const me ={
    firstName: 'Than',
    superHeroName: 'el pollo loco',
    homeTown: 'Provo',
    superPowers: ['flying', 'fighting', 'eating chicken'],
...
const regularName = 'Than'
const superName = 'el pollo loco'
const homeTown = 'Provo'
...
function setColor(arr){
    // arr.splice(0, arr.length -(arr.length - 2));
    // so i was pretty sure that the splice would work with those parameters... my thought process was for the splice to delete the length of the array minus four....but it didnt work. so i figured that as long as the parameters going into the function background were only the first three colors of the array it didnt really matter all that much. i would howerver love to see the solution as to how to code the first part. spliceing everything but three.
